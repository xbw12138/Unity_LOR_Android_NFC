...
public class Demo : MonoBehaviour
{
    ...
    void Start()
    {
        ShareSDK.setCallbackObjectName("Player");
        ShareSDK.open("bee2ec7e0972");

        //iOS 
        //Sina Weibo
        Hashtable sinaWeiboConf = new Hashtable();
        sinaWeiboConf.Add("app_key", "2790722944");
        sinaWeiboConf.Add("app_secret", "6b1ed0da86621e931b9e8ba6296c6394");
        sinaWeiboConf.Add("redirect_uri", "http://www.sina.com");
